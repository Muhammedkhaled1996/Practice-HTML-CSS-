...
export default function ProfilePage() {
  ...
  const {
    data: savedPostsData,
    isFetched: savedPostsIsFetched,
    isLoading: savedPostsIsLoading,
  } = usePost(["savedPosts"], true, `users/bookmarks`);
      ...
      {savedPostsIsFetched && (
        <div className="flex flex-col">
          ...
          <div className="cursor-pointer relative h-48 md:h-70 rounded-t-2xl overflow-hidden bg-linear-to-r from-slate-700 via-slate-600 to-slate-800 group">
            ...
            <label
              htmlFor="coverPhoto"
              className="size-8 flex justify-center items-center opacity-100 md:opacity-0 group-hover:scale-110 group-hover:opacity-100 duration-200 transition-all absolute top-2 right-2 bg-blue-500 text-white rounded-full p-1 shadow-md cursor-pointer z-10"
            >
              <IoCameraOutline />
            </label>
            <input
          ...
          <PhotoProvider>
            <div className="bg-white rounded-b-2xl shadow-sm px-6 pb-6">
              {/* Avatar */}
              <div className="flex flex-col lg:flex-row justify-between gap-4 bg-white px-3 pt-3 rounded-t-2xl -mt-14 relative z-10">
                <div className="flex justify-center gap-4">
                  <div className="relative group cursor-pointer w-fit">
                    ...
                    <label
                      ...
                      className="size-8 flex justify-center items-center opacity-100 md:opacity-0 hover:scale-110 group-hover:opacity-100 duration-200 transition-all absolute bottom-1 right-1 bg-blue-500 text-white rounded-full p-1 shadow-md cursor-pointer"
                    >
                      <IoCameraOutline />
                    </label>
                    ...
                    <PhotoView key={_id} src={photo || profileDefaultImage}>
                      <div className="size-8 flex justify-center items-center opacity-100 md:opacity-0 hover:scale-110 group-hover:opacity-100 duration-200 transition-all absolute bottom-1 left-1 bg-white rounded-full p-1 text-gray-600 shadow-md">
                        <TiArrowMaximise />
                      </div>
                    </PhotoView>
                  </div>
              ...
              {/* About + Post Stats */}
              <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 p-3">
                {/* About */}
